...
public abstract class OpenGLApi
{
    ...
    public abstract void glGetIntegerv(int bit, out int data);
    public abstract void glGetIntegerv(int bit, int[] data);
    public abstract void glActiveTexture(int bit);
    public abstract void glGetVertexAttribiv(int index, int bit, out int data);
    ...
    public abstract unsafe void glVertexAttribPointer(int index, int length, int type, bool b, int size, nint arr);
    ...
    public abstract unsafe void glDrawElements(int type, int count, int type1, nint arry);
    ...
    public abstract void glBufferData(int type, int v1, nint v2, int type1);
